<template>
  <div class="page">
    ...
    <div class="page-body">
      <p class="placeholder">人员管理模块开发中...</p>
    </div>
  </div>
</template>
...
.page-header {
  ...
  padding: 16px 20px; background: linear-gradient(135deg, #4facfe, #00f2fe); color: #fff;
}
.page-header h1 { font-size: 18px; font-weight: 600; }
.back { font-size: 14px; cursor: pointer; }
.page-body { padding: 40px 20px; text-align: center; }
